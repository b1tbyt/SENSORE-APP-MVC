...
{
    /// <summary>
    /// Simulates real-time pressure sensor data with smooth transitions.
    /// In production, this would connect to actual hardware sensors.
    /// </summary>
    public class PressureDataService
    {
        ...
        /// <summary>
        /// Starts the background service that updates pressure data.
        /// </summary>
        ...
        /// <summary>
        /// Gets a copy of the current heatmap.
        /// </summary>
